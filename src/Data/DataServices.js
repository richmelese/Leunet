...
const DataServices = [
    {
        ...
        shortDesc : "We specialize in secure, scalable enterprise networking solutions, enabling seamless communication, collaboration, and resource sharing to drive your organization's productivity and success.",
        ...
        childServices : [
            {
                id : 1, 
                img : child_service_img,
                title : "Network Solutions and SCS",
                shortDesc : "LeuNet offers Network Solutions and SCS, delivering comprehensive enterprise networking services for seamless communication, collaboration, and resource sharing within organizations.",
            ...
            },
            {
                ...
                shortDesc : "LeuNet offers WLAN solutions, providing secure and scalable wireless networking services for seamless connectivity and mobility within organizations.",
            ...
            },
            {
                ...
                shortDesc : "LeuNet provides Network Security Solutions, offering robust and comprehensive measures to protect your organization's network from cyber threats and ensure data confidentiality.",
            ...
            },
            {
                ...
                shortDesc : "LeuNet offers Collaboration/Conference Solutions, enabling seamless communication, virtual meetings, and efficient collaboration for teams across locations.",
        ...
        childServices : [
            {
                ...
                shortDesc : "With LeuNet ICT Solutions' data center AC systems, you can create an environment that ensures the optimal performance, reliability, and longevity of your critical IT infrastructure. Our solutions are designed to deliver efficient cooling, scalability, redundancy, and energy savings, allowing you to focus on your core business while we take care of your data center cooling needs.",
...
LeuNet ICT Solutions aims to create data center spaces that are not only functional but also visually appealing and conducive to productivity. We understand the importance of a well-designed and renovated data center in enhancing operational efficiency, employee satisfaction, and overall business performance. Trust us to transform your data center into a modern, efficient, and visually impressive facility that meets your operational needs and reflects your brand identity.</p>`
            },
            {
                ...
                shortDesc : "LeuNet ICT Solutions offers comprehensive solutions for cold aisle and hot aisle containments, as well as rack solutions, to optimize the airflow and cooling efficiency in your data center.",
                desc : `LeuNet ICT Solutions provides efficient and reliable data center air conditioning (AC) systems to ensure optimal cooling and temperature control within your data center facility. We understand the criticality of maintaining an optimal operating environment for your IT infrastructure, and our AC systems are designed to meet the specific cooling requirements of data centers. Here is a small description of our Data Center AC system services:
<p>
...
<p>Hot Aisle Containment: Our hot aisle containment solutions focus on isolating and containing the hot air generated by IT equipment. By enclosing the hot aisles with containment structures, we ensure that the hot air is efficiently captured and directed towards the cooling system for effective removal. Hot aisle containment helps improve cooling system performance, reduces energy consumption, and enhances overall data center efficiency.</p>`
    ...
    },
    {
        ...
        shortDesc: "LeuNet ICT Solutions specializes in designing and implementing smart infrastructure and IoT (Internet of Things) systems that enable organizations to harness the power of connected devices and data-driven technologies.",
        ...
        childServices : [
            {
                ...
                shortDesc : "LeuNet ICT Solutions offers IT virtual consultancy services to assist businesses and organizations remotely with their technology needs and challenges. Our virtual consultancy services provide a flexible and convenient way to access expert advice and guidance without the need for on-site visits.",
